                            ...
                            @if(auth()->check() && auth()->user()->isAdmin())
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="adminDropdown">
                                        ...
                                        <li><a class="dropdown-item" href="{{ route('admin.stands.index') }}">Demandes de stand</a></li>
                                        <li><a class="dropdown-item" href="#">Utilisateurs</a></li>
                                    </ul>
                                </li>
                            @elseif(auth()->check() && auth()->user()->isEntrepreneurApprouve())
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('entrepreneur.dashboard') }}">Mon espace</a>
                                </li>
                            @endif
                        @endauth
                    </ul>
